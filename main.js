    ...
    (() => {
                ...
                return n().createElement(
                    ...
                    n().createElement(
                        "a",
                        {
                            ...
                            rel: "noreferrer",
                            className:
                                " flex items-center group rounded-2xl bg-white py-2 px-3 md:py-3 mb-4 md:px-4 last:mb-0 transition-all border-2  hover:bg-gradient-to-r  from-[#EF302B] to-[#00A2E0] outline-none hover:scale-105 text-black ".concat(
                                    !c && "opacity-60",
                                    " shadow-md"
                                ),
                            onClick: function (t) {
        ...
        const j = function (t) {
            ...
            z = {
                ...
                cover_img_absolute:
                    "https://bizweb.dktcdn.net/100/078/567/products/backdrop-phong-noel-giang-sinh-merry-christmas-94.jpg?v=1575259228447",
                username: "linkstar",
                user_links: [
                    {
                        uuid: 1,
                    ...
                    n().createElement(
                        ...
                        n().createElement(
                            ...
                            n().createElement(
                                ...
                                {
                                    className:
                                        "relative grid min-h-full backdrop-blur-2xl bg-cover bg-[url('https://thuthuatnhanh.com/wp-content/uploads/2022/05/background-giang-sinh-nen-tuyet-trang-1.jpg')]"
                                },
                                n().createElement(
                                    "div",
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement(
                                            ...
                                            n().createElement(
                                                ...
                                                {
                                                    className:
                                                        "mt-10 text-[#EF302B] font-semibold text-center  md:text-lg"
                                                },
                                                n().createElement(
                                                    "div",
